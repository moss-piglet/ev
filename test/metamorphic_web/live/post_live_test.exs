defmodule MetamorphicWeb.PostLiveTest do
  use MetamorphicWeb.ConnCase

  import Phoenix.LiveViewTest
  import Metamorphic.TimelineFixtures

  @create_attrs %{body: "some body", username: "some username", favs_count: 42, reposts_count: 42}
  @update_attrs %{
  ...
  @invalid_attrs %{body: nil, username: nil, favs_count: nil, reposts_count: nil}
