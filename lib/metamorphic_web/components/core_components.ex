defmodule MetamorphicWeb.CoreComponents do
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-brand-900 hover:bg-brand-700 py-2 px-3",
    ...
    <div class="rounded-md bg-brand-50 p-4 mt-8">
      <div class="flex">
        <div class="flex-shrink-0">
          <svg class="h-5 w-5 text-brand-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
        ...
        <div class="ml-3 flex-1 md:flex md:justify-between">
          ...
          <p class="mt-3 text-sm md:ml-6 md:mt-0">
            <.link navigate={@navigate} class="whitespace-nowrap font-medium text-brand-700 hover:text-brand-600">
              <%= @nav_title %>
